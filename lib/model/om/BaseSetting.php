...
abstract class BaseSetting extends BaseObject  implements Persistent {
  ...
  const PEER = 'SettingPeer';
	...
	public function setDomain($v)
	{
		...
		if ($this->domain !== $v) {
			$this->domain = $v;
			$this->modifiedColumns[] = SettingPeer::DOMAIN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = SettingPeer::NUM_COLUMNS - SettingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SettingPeer::DOMAIN)) $criteria->add(SettingPeer::DOMAIN, $this->domain);
